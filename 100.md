...
Go to your Docker Hub page , click Webhooks, then CREATE A WEBHOOK. For the Webhook URL, you need to provide the URL obtained from the step above. This will configure Continuous deployment to your web app from Docker Hub repository
